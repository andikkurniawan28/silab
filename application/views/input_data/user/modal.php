            ...
            <div class="modal-body">
                <form action="<?=$form_handler_create;?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="" name="password" step="any">
                    </div>
                    <div class="mb-3">
                        <label for="">Nama</label>
                        <input type="text" class="form-control" id="" name="nama" step="any">
                    </div>
                    <div class="mb-3">
                        <label for="">Role</label>
                        <input type="text" class="form-control" id="" name="role" step="any">
                    </div>
            </div>
