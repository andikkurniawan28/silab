    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?=base_url('welcome/hasil_analisa/penguapan');?>">Penguapan</a></li>
            <li class="breadcrumb-item active" aria-current="page"><?=$page_title;?></li>
            <li class="breadcrumb-item"><a href="<?=base_url('welcome/download_analisa_penguapan/'.$id);?>">Download Excel</a></li>
        </ol>
    </nav>
    <hr><br>
