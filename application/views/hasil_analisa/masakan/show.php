<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?=base_url('hasil_analisa/masakan');?>">Masakan</a></li>
            <li class="breadcrumb-item active" aria-current="page"><?=$page_title;?></li>
            <li class="breadcrumb-item"><a href="<?=base_url('hasil_analisa/masakan/download/'.$page_id);?>">Download</a></li>
        </ol>
    </nav>
